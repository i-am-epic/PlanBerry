...
const services = [
  {
    ...
    description:
      "We partner with the world's most ambitious brands to produce events that move markets — from C-suite summits to product launches that generate press.",
    capabilities: [
      "Conference & Summit Production",
      "AV / Staging / Live Direction",
      "Brand Activations & Launches",
      "Run-of-Show Management",
      "Speaker & Talent Coordination",
      "Global Logistics & Vendor Network",
    ],
    cta: "For corporates",
    image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1600&q=80",
  },
  {
    title: "Celebrations & Private",
    badge: "CELEBRATIONS",
    tagline: "Once in a lifetime, executed flawlessly.",
    description:
      "Weddings, milestone galas, and private gatherings — designed with obsessive detail and built around the people who matter most to you.",
    capabilities: [
      "Wedding Design & Production",
      "Décor Sourcing & Floristry",
      "Artist & Entertainment Booking",
      "Heritage & Cultural Specialists",
      "Venue Curation & Negotiation",
